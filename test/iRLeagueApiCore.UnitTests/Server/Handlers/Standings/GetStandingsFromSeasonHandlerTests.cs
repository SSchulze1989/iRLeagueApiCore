...
public sealed class GetStandingsFromSeasonHandlerTests : StandingsHandlerTestsBase<GetStandingsFromSeasonHandler, GetStandingsFromSeasonRequest, IEnumerable<StandingsModel>>
{
    protected override GetStandingsFromSeasonHandler CreateTestHandler(LeagueDbContext dbContext, IValidator<GetStandingsFromSeasonRequest> validator)
    {
        return new GetStandingsFromSeasonHandler(logger, dbContext, new[] { validator },
            new MemoryCache(new MemoryCacheOptions()));
    }

    protected override GetStandingsFromSeasonRequest DefaultRequest()
    {
        return new GetStandingsFromSeasonRequest(TestSeasonId);
    }
    ...
    public async Task ShouldReturnCachedResult_OnSubsequentCall()
    {
        ...
        var handler = new GetStandingsFromSeasonHandler(logger, db,
