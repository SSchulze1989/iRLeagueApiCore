...
namespace iRLeagueApiCore.Server.Controllers
{
    ...
    {
        [HttpGet]
        public async Task<ActionResult<IEnumerable<GetLeagueModel>>> Get([FromQuery] long[] ids, [FromServices] IDbContextFactory<LeagueDbContext> dbContextFactory)
        {
        ...
        [HttpPut]
        public async Task<ActionResult<GetLeagueModel>> Put([FromBody] PutLeagueModel putLeague, [FromServices] IDbContextFactory<LeagueDbContext> dbContextFactory)
        {
            using (var dbContext = dbContextFactory.CreateDbContext())
            {
