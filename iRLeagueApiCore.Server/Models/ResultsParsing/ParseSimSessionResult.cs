...
{
    public struct ParseSimSessionResult
	{
        ...
        public ParseTrack track { get; set; }
        public ParseWeather weather { get; set; }
        public ParseTrackState track_state { get; set; }
        public ParseSessionResult[] session_results { get; set; }
    }
}
