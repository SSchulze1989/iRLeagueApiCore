...
namespace iRLeagueDatabaseCore.Migrations
{
    ...
    [Migration("20260607083754_DriverPointsBalance")]
    partial class DriverPointsBalance
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("iRLeagueDatabaseCore.Models.DriverPointsAccountEntity", b =>
                {
                    b.Property<long>("LeagueId")
                        .HasColumnType("bigint");
                    ...
                    b.HasKey("LeagueId", "AccountId");

                    b.HasAlternateKey("AccountId");

                    b.HasIndex("LeagueId", "MemberId");

                    b.ToTable("DriverPointsAccounts", (string)null);
                });

            modelBuilder.Entity("iRLeagueDatabaseCore.Models.DriverPointsAccountSeason", b =>
                {
                    b.Property<long>("LeagueId")
                        .HasColumnType("bigint");
                    ...
                    b.HasKey("LeagueId", "AccountId", "SeasonId");

                    b.HasIndex("LeagueId", "SeasonId");

                    b.ToTable("DriverPointsAccountSeasons", (string)null);
                });

            modelBuilder.Entity("iRLeagueDatabaseCore.Models.DriverPointsBalanceEntity", b =>
                {
                    b.Property<long>("LeagueId")
                        .HasColumnType("bigint");
                    ...
                    b.HasKey("LeagueId", "AccountId", "EntryKindId");

                    b.HasIndex("EntryKindId");

                    b.HasIndex("LeagueId", "AccountId");

                    b.HasIndex("LeagueId", "EntryKindId");

                    b.ToTable("DriverPointsBalances", (string)null);
                });

            modelBuilder.Entity("iRLeagueDatabaseCore.Models.DriverPointsEntryEntity", b =>
                {
                    b.Property<long>("LeagueId")
                        .HasColumnType("bigint");

                    b.Property<long>("AccountEntryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasKey("LeagueId", "AccountEntryId");

                    b.HasAlternateKey("AccountEntryId");
                    ...
                    b.ToTable("DriverPointsEntries", (string)null);
                });

            modelBuilder.Entity("iRLeagueDatabaseCore.Models.DriverPointsEntryKindEntity", b =>
                {
                    b.Property<long>("EntryKindId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasKey("EntryKindId");

                    b.HasIndex("LeagueId", "EntryType");

                    b.ToTable("DriverPointsEntryKinds", (string)null);
                });

            modelBuilder.Entity("iRLeagueDatabaseCore.Models.DriverPointsExpiryRuleEntity", b =>
                {
                    b.Property<long>("LeagueId")
                        .HasColumnType("bigint");

                    b.Property<long>("ExpiryRuleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<int?>("EventsDriven")
                        .HasColumnType("int");

                    b.Property<int?>("EventsMissed")
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("ResetOnNewSeason")
                        .HasColumnType("tinyint(1)");

                    b.HasKey("LeagueId", "ExpiryRuleId");

                    b.HasAlternateKey("ExpiryRuleId");

                    b.HasIndex("LeagueId", "PenaltyType");

                    b.ToTable("DriverPointsExpiryRules", (string)null);
                });
            ...
            modelBuilder.Entity("iRLeagueDatabaseCore.Models.RosterEntity", b =>
                {
                    b.Property<long>("LeagueId")
                        .HasColumnType("bigint");
                    ...
                    b.HasKey("LeagueId", "RosterId");

                    b.HasAlternateKey("RosterId");

                    b.ToTable("Rosters", (string)null);
                });

            modelBuilder.Entity("iRLeagueDatabaseCore.Models.RosterEntryEntity", b =>
                {
                    b.Property<long>("LeagueId")
                        .HasColumnType("bigint");
                    ...
                    b.HasKey("LeagueId", "RosterId", "MemberId");

                    b.HasIndex("LeagueId", "MemberId");

                    b.HasIndex("LeagueId", "TeamId");

                    b.HasIndex("RosterId", "MemberId");
            ...
            modelBuilder.Entity("iRLeagueDatabaseCore.Models.DriverPointsAccountSeason", b =>
                {
                    b.HasOne("iRLeagueDatabaseCore.Models.DriverPointsAccountEntity", "Account")
                        .WithMany("Seasons")
                        .HasForeignKey("LeagueId", "AccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("iRLeagueDatabaseCore.Models.DriverPointsBalanceEntity", b =>
                {
                    b.HasOne("iRLeagueDatabaseCore.Models.DriverPointsEntryKindEntity", "EntryKind")
                        .WithMany()
                        .HasForeignKey("EntryKindId")
