...
public sealed class GetUserHandler : UsersHandlerBase<GetUserHandler,  GetUserRequest, UserModel>
{
    ...
    public override async Task<UserModel> Handle(GetUserRequest request, CancellationToken cancellationToken)
    {
