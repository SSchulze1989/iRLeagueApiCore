...
public sealed class GetEventHandler : EventHandlerBase<GetEventHandler,  GetEventRequest, EventModel>
{
    ...
    public override async Task<EventModel> Handle(GetEventRequest request, CancellationToken cancellationToken)
    {
