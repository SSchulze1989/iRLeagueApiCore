...
public sealed class PutPointRuleHandler : PointRuleHandlerBase<PutPointRuleHandler,  PutPointRuleRequest, PointRuleModel>
{
    ...
    public override async Task<PointRuleModel> Handle(PutPointRuleRequest request, CancellationToken cancellationToken)
    {
