...
public sealed class GetSeasonHandler : SeasonHandlerBase<GetSeasonHandler,  GetSeasonRequest, SeasonModel>
{
    ...
    public override async Task<SeasonModel> Handle(GetSeasonRequest request, CancellationToken cancellationToken)
    {
