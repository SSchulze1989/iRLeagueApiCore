...
public sealed class GetResultHandler : ResultHandlerBase<GetResultHandler, GetResultRequest, EventResultModel>
{
    ...
    public override async Task<EventResultModel> Handle(GetResultRequest request, CancellationToken cancellationToken)
    {
